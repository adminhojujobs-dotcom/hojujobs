...
export const REGION_GROUPS: RegionGroup[] = [
  ...
  { state: "NSW", region: "시드니 시티", suburbs: [
    ...
    "레드펀", "록스", "드러모인", "드라모인", "바랑가루", "팟츠 포인트", "피어몬트", "타운홀", "매릭빌",
  ...
  { state: "NSW", region: "라이드 / 이스트우드", suburbs: [
    ...
    "리달미어", "맥쿼리 파크", "글레이즈빌", "멜로즈 파크", "노스 라이드", "퍼트니",
  ]},
  ...
  { state: "NSW", region: "힐스 지구", suburbs: [
    ...
    "리버스톤", "매스든 파크", "엘라라", "스코필드", "버큼힐", "윈스턴 힐스", "보몬트 힐스", "세븐 힐스", "벨라 비스타",
  ]},
  ...
  { state: "NSW", region: "사우스웨스트", suburbs: [
    ...
    "블랙타운", "캐브라마타", "웨더릴 파크", "카술라", "라켐바", "레이컴바", "벨모어", "세인트 메리스", "스미스필드", "빌라우드", "레브즈비", "출로라", "무어뱅크", "오크허스트",
  ]},
  ...
  { state: "VIC", region: "이너 이스트 멜버른", suburbs: [
    ...
    "말번", "볼윈", "돈캐스터", "링우드", "미첨", "누나와딩", "박스 힐", "보로니아", "호손", "완티나", "캔터베리",
  ]},
  { state: "VIC", region: "사우스 이스트 멜버른", suburbs: [
    "사우스 이스트 멜버른", "채드스톤", "오클리", "오클리 이스트", "글렌 헌틀리", "헌팅데일", "카네기", "단데농", "댄드농", "녹스", "비스",
    "스프링베일", "클레이턴", "엔데버 힐스", "무라빈", "휠러스 힐", "멀그레이브", "치즐럼", "애스펜데일", "오피서",
  ]},
  { state: "VIC", region: "노스 멜버른", suburbs: [
    "브로드메도우스", "에핑 (VIC)", "크레이기번", "선샤인", "노스 멜버른", "노스코트", "윌리엄스 랜딩", "디어 파크", "에센든", "케일러", "레이븐홀", "테일러스 레이크",
  ]},
