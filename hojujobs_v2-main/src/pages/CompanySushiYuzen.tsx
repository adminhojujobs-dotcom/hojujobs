...
const fallbackJobOpenings: JobOpening[] = [
  { id: "fallback-1", area: "NSW", suburb: "Parramatta", title: "SUSHI YUZEN 직원 모집", company: "SUSHI YUZEN", pay: "$31.19 ~ $35.15 + Super", payType: "시급", hours: "매장별 상이 (예: 08:00~14:30)", postedAt: "상시" },
];
