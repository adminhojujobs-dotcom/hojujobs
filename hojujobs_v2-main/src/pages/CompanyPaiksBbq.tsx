...
const fallbackProfile: CompanyProfileRow = {
  ...
  slug: "paiksbbq",
  name: "PAIK'S BBQ",
  profile_title: "PAIK'S BBQ 직원 모집",
  subtitle: "멜버른 도심의 한식 바베큐집",
  logo_url: "https://ui-avatars.com/api/?name=PAIK%27S+BBQ&background=111827&color=fff&size=256&bold=true",
  photo_url: "https://static.where-e.com/Australia/Paik-S-Bbq_31c30b5ff7140ca87a6a040c5f076fe4.jpg",
  phone: "03 9972 2043",
  email: "saemaul10082018@gmail.com",
  address: "525 Little Lonsdale St, Melbourne VIC 3000",
  map_query: "525 Little Lonsdale St, Melbourne VIC 3000",
  skill_tags: ["홀 서빙", "주방 보조", "키친핸드", "고객응대", "테이블 정리", "위생관리"],
  is_active: true,
  created_at: "",
  updated_at: "",
};
...
const fallbackJobOpenings: JobOpening[] = [
  { id: "fallback-1", area: "VIC", suburb: "Melbourne CBD", title: "PAIK'S BBQ Lonsdale점 홀/주방 직원 모집", company: "PAIK'S BBQ Lonsdale점", pay: "면접 시 협의", payType: "급여", hours: "풀타임 / 파트타임", postedAt: "상시" },
];

export default function CompanyPaiksBbq() {
  const { slug = "paiksbbq" } = useParams();
  ...
  useSEO({
    ...
    htmlLang: "ko",
    ogLocale: "ko_KR",
    keywords: `${profile.name} 채용, PAIK'S BBQ 구인, Korean BBQ 멜버른, 멜버른 한인 구인`,
  });
          ...
          <section className="mt-16">
            ...
            <div className="border-y border-t-neutral-950 border-b-slate-200 bg-white">
              {Array.from({ length: 2 }).map((_, index) => (
                <div key={`paiksbbq-job-skeleton-${index}`} className="grid gap-4 border-b border-slate-200 px-5 py-7 lg:grid-cols-[10rem_minmax(0,1fr)_11rem_9rem]">
