    ...
    <div className="flex min-h-0 w-full flex-1 flex-col bg-white">
      <main className="mx-auto w-full max-w-[1220px] px-5 py-8 sm:py-12">
        ...
        <div className="overflow-hidden border-y border-t-neutral-950 border-b-slate-200 bg-white">
          <div className="hidden grid-cols-[3.5rem_minmax(0,1fr)_minmax(0,1.4fr)] items-center border-b border-slate-200 px-5 py-4 text-sm font-black text-neutral-950 sm:grid">
            <div />
            <button
              type="button"
              onClick={toggleSort}
            ...
            <div className="divide-y divide-slate-200">
              {filteredProfiles.map((profile) => (
                <button
                  ...
                  className="grid w-full grid-cols-[2.75rem_minmax(0,1fr)] items-center gap-3 px-5 py-4 text-left transition-colors hover:bg-slate-50 focus-visible:bg-slate-50 focus-visible:outline-none sm:grid-cols-[3.5rem_minmax(0,1fr)_minmax(0,1.4fr)] sm:gap-0"
                >
