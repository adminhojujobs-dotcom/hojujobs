...
const fallbackProfile: CompanyProfileRow = {
  ...
  slug: "bbqcode",
  name: "BBQ Code",
  profile_title: "BBQ Code 직원 모집",
  subtitle: "멜버른 숯불 바베큐 전문점",
  logo_url: "https://www.google.com/s2/favicons?domain=bbqcode.com.au&sz=256",
  photo_url: "https://images.unsplash.com/photo-1529042410759-befb1204b468?auto=format&fit=crop&w=1600&q=80",
  phone: "+61 416 496 977",
  email: "eat@bbqcode.com.au",
  address: "249 Springvale Rd, Glen Waverley VIC 3150",
  map_query: "249 Springvale Rd, Glen Waverley VIC 3150",
...
const fallbackJobOpenings: JobOpening[] = [
  { id: "fallback-1", area: "VIC", suburb: "Glen Waverley", title: "BBQ Code Glen Waverley점 홀/주방 직원 모집", company: "BBQ Code Glen Waverley점", pay: "면접 시 협의", payType: "급여", hours: "풀타임 / 파트타임", postedAt: "상시" },
];

export default function CompanyBbqCode() {
  const { slug = "bbqcode" } = useParams();
  ...
  useSEO({
    ...
    htmlLang: "ko",
    ogLocale: "ko_KR",
    keywords: `${profile.name} 채용, BBQ Code 구인, Korean BBQ 멜버른, 멜버른 한인 구인`,
  });
          ...
          <section className="mt-16">
            ...
            <div className="border-y border-t-neutral-950 border-b-slate-200 bg-white">
              {Array.from({ length: 2 }).map((_, index) => (
                <div key={`bbqcode-job-skeleton-${index}`} className="grid gap-4 border-b border-slate-200 px-5 py-7 lg:grid-cols-[10rem_minmax(0,1fr)_11rem_9rem]">
