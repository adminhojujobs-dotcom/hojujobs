...
const NEWS_ARTICLES = [
  {
    title: "멜버른 고급 아파트, '저렴한 주택' 경로로 빠른 승인",
    date: "2026년 5월 20일",
    publishedAt: "2026-05-20T05:03:00+10:00",
    year: 2026,
    tag: "주거",
    summary: "ABC는 멜버른에서 일부 고급 아파트와 논란이 큰 개발안이 저렴한 주택 공급을 위한 패스트트랙 제도로 승인되고 있다고 보도했습니다. 렌트난을 겪는 유학생·워홀러에게는 '공급 확대'가 실제 저렴한 방으로 이어지는지 지켜볼 만한 이슈입니다.",
    link: "https://www.abc.net.au/news/2026-05-20/luxury-apartments-greenlit-under-affordable-housing-scheme/106680592",
    source: "ABC News",
    domain: "abc.net.au",
  },
  {
    title: "디프테리아 220건 넘어, 연방정부 지원 패키지 준비",
    date: "2026년 5월 20일",
    publishedAt: "2026-05-20T12:51:00+10:00",
    year: 2026,
    tag: "건강",
    summary: "ABC는 2026년 호주 디프테리아 확진이 NT, WA, SA, QLD에서 220건을 넘었고, 연방정부가 백신·인력 지원을 준비 중이라고 전했습니다. 지역 이동이 잦은 워홀러와 쉐어하우스 거주자는 예방접종 기록과 가까운 GP·약국을 확인해 두세요.",
    link: "https://www.abc.net.au/news/2026-05-20/federal-government-diphtheria-support-cases-grow/106700196",
    source: "ABC News",
    domain: "abc.net.au",
  },
  {
    title: "Anthropic 호주 유치 논의, AI 일자리·보안 관심",
    date: "2026년 5월 20일",
    publishedAt: "2026-05-20T16:41:00+10:00",
    year: 2026,
    tag: "기술",
    summary: "ABC는 Claude 개발사 Anthropic의 최고법률책임자가 호주 정부 관계자들과 비공개 회의를 위해 방문했다고 보도했습니다. AI·사이버보안 분야 채용, 스타트업, 기술비자 흐름에 관심 있는 한국인 구직자에게는 호주 테크 생태계의 방향을 보여주는 뉴스입니다.",
    link: "https://www.abc.net.au/news/2026-05-20/anthropic-jeffery-bleich-in-australia-for-government-talks/106696532",
    source: "ABC News",
    domain: "abc.net.au",
  },
  {
    title: "예산 세제개편, 스타트업·투자자 우려 확산",
    date: "2026년 5월 20일",
    publishedAt: "2026-05-20T04:51:00+10:00",
    year: 2026,
    tag: "창업",
    summary: "ABC는 자본이득세와 신탁 관련 예산 개편을 두고 스타트업과 젊은 투자자들의 반발이 커지고 있다고 전했습니다. 호주에서 ABN, 소규모 사업, 프리랜서, 창업을 생각하는 사람은 세금 구조 변화가 수익과 투자 계획에 어떤 영향을 주는지 확인해야 합니다.",
    link: "https://www.abc.net.au/news/2026-05-20/labor-albanese-tax-overhaul-alarms-startups-investors/106698988",
    source: "ABC News",
    domain: "abc.net.au",
  },
  {
    title: "퀸즐랜드 대형 탄광 매각, 지역 일자리 우려",
    date: "2026년 5월 20일",
    publishedAt: "2026-05-20T12:41:00+10:00",
    year: 2026,
    tag: "지역",
    summary: "ABC는 Dhilmar가 Anglo American의 퀸즐랜드 석탄광산 5곳을 인수하면서 Bowen Basin 지역사회가 새 소유주의 운영 계획을 주시하고 있다고 보도했습니다. 광산·지역 서비스업·숙박업 일자리를 보는 워홀러에게는 지역 경기와 고용 안정성에 영향을 줄 수 있는 소식입니다.",
    link: "https://www.abc.net.au/news/2026-05-20/anglo-american-sale-dhilmar-sparks-community-concern/106697588",
    source: "ABC News",
    domain: "abc.net.au",
  },
  {
    title: "밀두라 인근 다중 추돌 사망, 고속도로 폐쇄",
    date: "2026년 5월 20일",
    publishedAt: "2026-05-20T12:40:00+10:00",
    year: 2026,
    tag: "교통",
    summary: "ABC는 VIC·NSW 경계 근처 Trentham Cliffs에서 다중 추돌 사고로 1명이 숨지고 Sturt Highway가 양방향 폐쇄됐다고 전했습니다. 지방 운전, 로드트립, 농장 이동을 하는 워홀러는 장거리 운전 전 도로 폐쇄와 피로 운전 위험을 꼭 확인하세요.",
    link: "https://www.abc.net.au/news/2026-05-20/man-dead-after-crash-near-nsw-vic-border/106700934",
    source: "ABC News",
    domain: "abc.net.au",
  },
  {
    title: "SBS 한국어 3분 브리핑: 주택·RBA·시드니 사건 정리",
    date: "2026년 5월 20일",
    publishedAt: "2026-05-20T10:42:00+10:00",
    year: 2026,
    tag: "한국어",
    summary: "SBS Korean은 5월 20일 브리핑에서 주택 용도 변경 관련 불로소득 보고서, 중동 분쟁 장기화 시 인플레이션 우려, 시드니 남서부 총격 사건 등을 한국어로 짧게 정리했습니다. 영어 기사 확인이 부담스러운 한인 독자에게 빠르게 흐름을 잡기 좋은 소스입니다.",
    link: "https://www.sbs.com.au/language/korean/ko/podcast-episode/korean-short-news-200526/1s4jlrw8j",
    source: "SBS Korean",
    domain: "sbs.com.au",
  },
];
      ...
      <div className="max-w-4xl mx-auto px-4 pt-4 pb-8 w-full space-y-5">
        ...
        <div className="rounded-lg border bg-card overflow-hidden">
          <div className="px-4 py-3 border-b">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">2026년 5월 20일 기사만 · 주거, 건강, 기술, 지역</p>
          </div>
