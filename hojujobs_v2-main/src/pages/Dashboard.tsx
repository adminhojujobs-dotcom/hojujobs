...
const NEWS_ARTICLES = [
  {
    title: "호주 첫 우주인, 국제우주정거장 임무 제안 받아",
    date: "2026년 5월 25일",
    publishedAt: "2026-05-25T20:28:00+10:00",
    year: 2026,
    tag: "기술",
    summary: "ABC는 호주 최초의 정식 우주인 캐서린 베넬-페그가 유럽우주국의 향후 ISS 임무 참여 제안을 받았다고 전했습니다. 자금 조달이 필요하지만, 호주 우주 산업과 STEM 교육에 큰 기회가 될 수 있는 소식입니다.",
    link: "https://www.abc.net.au/news/2026-05-25/iss-mission-offered-to-australias-first-astronaut/106719690",
    source: "ABC News",
    domain: "abc.net.au",
  },
  {
    title: "NRL CEO 앤드루 압도, 테니스 오스트레일리아 대표로 이동",
    date: "2026년 5월 25일",
    publishedAt: "2026-05-25T16:02:00+10:00",
    year: 2026,
    tag: "스포츠",
    summary: "ABC는 NRL 최고경영자 앤드루 압도가 성공적인 6년 임기를 마치고 테니스 오스트레일리아 CEO로 이동한다고 보도했습니다. 호주 스포츠 조직의 리더십 변화와 향후 확장 계획을 이해하기 좋은 중립적인 기사입니다.",
    link: "https://www.abc.net.au/news/2026-05-25/andrew-abdo-quits-nrl-chief-eying-tennis-australia-role/106717492",
    source: "ABC Sport",
    domain: "abc.net.au",
  },
  {
    title: "멜번 18세 비앙카 애들러, 호주 최연소 에베레스트 등정",
    date: "2026년 5월 25일",
    publishedAt: "2026-05-25T12:30:00+10:00",
    year: 2026,
    tag: "한국어",
    summary: "SBS Korean은 멜버른 출신 18세 비앙카 애들러가 에베레스트 정상에 오르며 호주 최연소 등정 기록을 세웠다고 전했습니다. 도전과 성취를 다룬 밝은 소식으로, 한국어로 편하게 들을 수 있습니다.",
    link: "https://www.sbs.com.au/language/korean/ko/podcast-episode/melbourne-teenager-becomes-youngest-australian-to-summit-mount-everestmount-everest/e60seccya",
    source: "SBS Korean",
    domain: "sbs.com.au",
  },
  {
    title: "시드니에서 클래식카 전기차 개조 관심 증가",
    date: "2026년 5월 25일",
    publishedAt: "2026-05-25T12:22:00+10:00",
    year: 2026,
    tag: "기술",
    summary: "SBS German은 호주의 전기차 시장과 클래식카 EV 개조 수요가 커지고 있으며, 시드니에서 독특한 전기 개조 차량이 만들어지고 있다고 소개했습니다. 기술, 친환경 이동수단, 지역 소규모 산업을 가볍게 볼 수 있는 기사입니다.",
    link: "https://www.sbs.com.au/language/german/en/podcast-episode/classic-cars-under-power-australias-boom-in-electric-cars-and-ev-conversions/5lxl3b5a9",
    source: "SBS German",
    domain: "sbs.com.au",
  },
  {
    title: "호주 원주민 깃발의 역사와 의미를 한국어로 설명",
    date: "2026년 5월 25일",
    publishedAt: "2026-05-25T16:00:00+10:00",
    year: 2026,
    tag: "문화",
    summary: "SBS Korean의 Australia Explained는 원주민 깃발이 호주의 공식 국기 중 하나가 된 과정과 색의 의미를 설명합니다. 호주 사회와 직장, 학교에서 자주 보게 되는 상징을 이해하는 데 도움이 되는 중립적이고 교육적인 콘텐츠입니다.",
    link: "https://www.sbs.com.au/language/korean/ko/podcast-episode/the-aboriginal-flag-history-meaning-and-recognition/co8bepqxj/",
    source: "SBS Korean",
    domain: "sbs.com.au",
  },
  {
    title: "호주 최연소 드래프트 1순위 트래비스 바자나, MLB 홈런 활약",
    date: "2026년 5월 25일",
    publishedAt: "2026-05-25T08:24:00+10:00",
    year: 2026,
    tag: "스포츠",
    summary: "ABC는 호주 야구 선수 트래비스 바자나가 클리블랜드 가디언스 경기에서 125m 홈런을 포함해 3안타를 기록했다고 전했습니다. 해외 무대에서 활약하는 호주 선수 소식이라 가볍고 긍정적으로 읽기 좋습니다.",
    link: "https://www.abc.net.au/news/2026-05-25/baseball-mlb-travis-bazzana-home-run-guardians-phillies/106717122",
    source: "ABC Sport",
    domain: "abc.net.au",
  },
  {
    title: "유학생 교육기관 신규 등록 1년 중단, 부실 운영 단속 강화",
    date: "2026년 5월 25일",
    publishedAt: "2026-05-25T08:44:00+10:00",
    year: 2026,
    tag: "유학",
    summary: "SBS Korean은 호주 정부가 유학생 대상 VET·ELICOS 교육기관의 신규 등록을 12개월 중단하고 품질 관리를 강화한다고 전했습니다. 유학생과 워홀러가 학교 선택 때 확인해야 할 제도 변화입니다.",
    link: "https://www.sbs.com.au/language/korean/ko/podcast-episode/suspension-of-new-vet-applications-to-teach-international-students/d524gnv37",
    source: "SBS Korean",
    domain: "sbs.com.au",
  },
];
...
const TAG_COLORS: Record<string, string> = {
  ...
  "교육": "bg-blue-50 text-blue-700",
  "문화": "bg-fuchsia-50 text-fuchsia-700",
};
      ...
      <div className="max-w-4xl mx-auto px-4 pt-4 pb-8 w-full space-y-5">
        ...
        <div className="rounded-lg border bg-card overflow-hidden">
          <div className="px-4 py-3 border-b">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">2026년 5월 25일 기사만 · 우주, 스포츠, 문화, 유학</p>
          </div>
