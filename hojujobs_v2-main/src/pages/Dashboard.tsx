...
const NEWS_ARTICLES = [
  ...
  },
  {
    ...
    date: "2026년 5월 12일",
    publishedAt: "2026-05-12T19:31:00+10:00",
    year: 2026,
    tag: "비자",
    summary: "2026-27 연방예산에는 워킹홀리데이 메이커 프로그램을 더 엄격히 관리하고, 수요가 높은 국가에는 비자 추첨제를 확대하는 방향이 포함됐습니다. 한국 워홀러는 현재 신청 조건과 지정근무 요건을 Home Affairs에서 다시 확인하는 것이 좋습니다.",
    link: "https://www.abc.net.au/news/2026-05-12/federal-budget-2026-winners-and-losers/106639966",
    source: "ABC News",
    domain: "abc.net.au",
  },
  {
    title: "순이민 전망 상향, 렌트·주거 논쟁 확대",
    date: "2026년 5월 13일",
    publishedAt: "2026-05-13T17:18:00+10:00",
    year: 2026,
    tag: "숙소",
    summary: "연방예산은 향후 순이민 전망을 기존보다 높게 잡았고, 야당은 이민 규모와 주택 공급을 연결하겠다고 압박하고 있습니다. 유학생·워홀러에게는 방 구하기 경쟁과 렌트비 흐름을 계속 지켜봐야 한다는 신호입니다.",
    link: "https://www.abc.net.au/news/2026-05-13/one-million-more-migrants-expected-before-2030/106674228",
    source: "ABC News",
    domain: "abc.net.au",
  },
  {
    title: "이주노동자 착취 단속서 체불·비자 협박 적발",
    date: "2026년 3월 31일",
    publishedAt: "2026-03-31T09:31:00+10:00",
    year: 2026,
    tag: "임금",
    summary: "Home Affairs가 운영하는 이주노동자 보호 프로그램 첫해에 임금 체불, 슈퍼 미지급, 비자 취소 협박, 현대판 노예제 사례가 드러났습니다. 현금잡·농장·공장·식당 일을 시작할 때 최저임금, 페이슬립, 슈퍼 지급을 꼭 확인하세요.",
    link: "https://www.abc.net.au/news/2026-03-31/migrant-worker-scheme-uncovers-stolen-wages-modern-slavery/106512360",
    source: "ABC News",
    domain: "abc.net.au",
  },
  {
    ...
    year: 2026,
    tag: "임금",
    summary: "Fair Work Commission 결정으로 소매·패스트푸드·약국 업종의 18-20세 주니어 임금이 2029년까지 성인 임금에 맞춰 단계적으로 올라갑니다. 해당 업종에서 일하는 젊은 워홀러와 유학생은 적용 시점과 어워드 임금을 확인해 두면 좋습니다.",
